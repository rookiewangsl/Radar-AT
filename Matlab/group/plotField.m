% calculate the solution of pekeris
clear;
clc;
close all;

[TitleEnv, Opt, Comp, MLimit, NProf, rProf, raxis, Pos] = read_flp('test');
clear read_modes_bin;
Modes = read_modes_bin('test.mod', 0);

srcz = reshape(Pos.s.depth, [], 1);
rcvz = reshape(Pos.r.depth, [], 1);
