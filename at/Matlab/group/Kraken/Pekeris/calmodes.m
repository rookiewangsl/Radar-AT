% --------------------说明------------------------
% calculate_Modes_lx.m 通过利用kraken，设置环境参数得到.env文件，.prt文件
% 之后计算出声场模式，得到声场模式.mod文件
% 之后可以写flp文件再计算声场，但是为了在计算声场时更改模式数目方便，这一部分写成了getflp_shd.m
% Author : Lingxuan Li
