...
!!$       END IF 
  ...
  SUBROUTINE ReadSzRz( ENVFile, PRTFile, zMin, zMax )
    ...
    IF ( Pos%NSz > Number_to_Echo ) WRITE( PRTFile, * ) ' ... ', Pos%sz( Pos%NSz )
    ...
    IF ( Pos%NRz > Number_to_Echo ) WRITE( PRTFile, * ) ' ... ', Pos%Rz( Pos%NRz )
...
!!$    END IF 
  ...
  SUBROUTINE ReadRcvrRanges( ENVFile, PRTFile )
    ...
    IF ( Pos%NRr > Number_to_Echo ) WRITE( PRTFile, * ) ' ... ', Pos%Rr( Pos%NRr )
